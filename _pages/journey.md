...
![Fridays fot Future - First demo in Prague]<img src="{{ site.baseurl }}/assets/img/fff.jpeg" alt="Fridays for Future - First demo in Prague" style="width: 40%; float: right; margin-left: 20px;">
